...
<div id="sidenav" class="ui inverted left fixed vertical menu">
      ...
      <div id="uifixed" class="ui fixed container"  >
        ...
        <div class="ui segment">
          ...
          <h2 class="ui dividing left header">Lita de Medicamentos</h2>
          <div class="ui left aligned basic segment">
          <form class="ui form" action="{{ route('save') }}" method="post">
              @csrf
              ...
              <div class="field">
                <label>Informacao do Fabricante</label>
                <div class="fields">
                  <div class="twelve wide field">
                    <input type="text" name="endereco_fabricante" placeholder="Endereco do Fabricante">
                  </div>
              ...
              <div class="two fields">
                <div class="field">
                  ...
                  <input type="text" name="telefone" placeholder="Numero de Telefeno">
                </div>
                <div class="field">
                  <label>Country</label>
              ...
              <h4 class="ui dividing header">Informacao Adicional</h4>
              <div class="fields">
                <div class="seven wide field">
                <label>Categoria</label>
                <div class="ui selection dropdown">
                  <input type="hidden" name="card[type]">
                  <div class="default text">Produtos</div>
                  <i class="dropdown icon"></i>
                  <div class="menu">
                ...
                <div class="six wide field">
                  ...
                  <input type="text" name="quantidade" maxlength="3" placeholder="01">
                </div>
              </div>
              <div class="fields">
                <div class="seven wide field">
                  <label>Marca</label>
                  <input type="text" name="marca" maxlength="16" placeholder="Marca">
                </div>
                <div class="three wide field">
                  <label>Dia </label>
                  <input type="text" name="ano_validade" maxlength="3" placeholder="01">
                </div>
                <div class="six wide field">
                  <label>Mes</label>
                  <div class="two fields">
               ...
               <h4 class="ui dividing header">Descricao</h4>
               <div class="field">
                <label>Descria:</label>
              ...
              <input class="ui left button" type="submit" onclick='saveProduto()' value="Submit Order" />
            </form>
